...
UAbilityMenuWidgetController* AAuraHUD::GetAbilityMenuWidgetController(const FWidgetControllerParams& WCParams)
{
...
void AAuraHUD::InitOverlay(APlayerController* PC, APlayerState* PS, UAbilitySystemComponent* ASC, UAttributeSet* AS)
{
	...
	checkf(OverlayWidgetControllerClass, TEXT("OverlayWidget Controller Class uninitialized, please fill out BP_AuraHUD"));
	...
	//Start Broadcasting Initial Values here

...
ATotwPlayerController::ATotwPlayerController()
{
	bReplicates = true;
...
void ATotwPlayerController::ShowAoeAbility(UMaterialInterface* DecalMaterial)
{
...
void ATotwPlayerController::HideAoeAbility()
{
	if (IsValid(AoeAbility))
	{
		AoeAbility->Destroy();
...
void ATotwPlayerController::ShowDamageNumber_Implementation(float DamageAmount, ACharacter* TargetCharacter, bool bBlockedHit, bool bCriticalHit)
{
...
void ATotwPlayerController::AutoRun()
{
...
void ATotwPlayerController::SetupInputComponent()
{
	...
	AuraInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATotwPlayerController::Move);
	AuraInputComponent->BindAction(ShiftAction, ETriggerEvent::Started, this, &ATotwPlayerController::ShiftPressed);
	AuraInputComponent->BindAction(ShiftAction, ETriggerEvent::Completed, this, &ATotwPlayerController::ShiftReleased);
